...
import AddPrice from './add-price/AddPrice.jsx';
import AddDescription from './add-description/AddDescription.jsx';
      ...
      <Wrapper>
         ...
         <Box>
            <TabContext value={tab}>
               ...
               <TabPanel value="1">
                  <TabPanelStyle>
                     <AddProduct setTab={handleTabChange} />
                  </TabPanelStyle>
               </TabPanel>
               <TabPanel value="2">
                  <AddPrice setTab={handleTabChange} />
               </TabPanel>
               <TabPanel value="3">
                  <AddDescription />
               </TabPanel>
